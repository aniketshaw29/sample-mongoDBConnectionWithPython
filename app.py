...
def conn():
     myclient=pymongo.MongoClient("mongodb+srv://AniketShaw:iLeKV1jthJZPKWpu@cluster0.mx1m72a.mongodb.net/?retryWrites=true&w=majority")
     mydb=myclient["deo"] #database name
     collection=mydb["bat"]  #collection = table name
     return collection
#def create_index():
  #  mycol=conn()
...
def create():
    if request.method=='POST':
        ...
        try:
            # mycol.db[mycol.mongo_collection].create_index("user_id", unique=True)
